...
function listAllEstadia() {
    ...
    $sql = 'select * , timediff((concat(dataDaSaida, " " , horaDaSaida)) ,   (concat(dataDaEntrada, " " , horaDaEntrada))) as diferenca from tblEstadia order by idEstadia desc';
...
function listEstadiaById( $id ) {
    ...
    $sql = 'select * , timediff((concat(dataDaSaida, " " , horaDaSaida)) ,   (concat(dataDaEntrada, " " , horaDaEntrada)) ) as diferenca from tblEstadia where idEstadia = ' . $id . " order by idEstadia desc";
    $select = mysqli_query($conex, $sql);
